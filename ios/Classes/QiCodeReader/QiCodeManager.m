        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            ...
            if ([self.session canAddOutput:output]) {
                ...
                if ([output.availableMetadataObjectTypes containsObject:AVMetadataObjectTypeQRCode] &&
                    ...
                    [output.availableMetadataObjectTypes containsObject:AVMetadataObjectTypeUPCECode] &&
                    [output.availableMetadataObjectTypes containsObject:AVMetadataObjectTypeITF14Code] && [output.availableMetadataObjectTypes containsObject:AVMetadataObjectTypeDataMatrixCode]) {
                    output.metadataObjectTypes = @[AVMetadataObjectTypeQRCode, AVMetadataObjectTypeCode128Code, AVMetadataObjectTypeEAN13Code, AVMetadataObjectTypeEAN8Code, AVMetadataObjectTypeUPCECode, AVMetadataObjectTypeITF14Code, AVMetadataObjectTypeDataMatrixCode];
                }
            }
