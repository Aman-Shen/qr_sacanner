...
- (instancetype)initWithFrame:(CGRect)frame rectFrame:(CGRect)rectFrame rectColor:(UIColor *)rectColor {
    ...
    if (self) {
        ...
        [_torchSwithButton setImage:[self imageNamed:@"qi_torch_switch_off"] forState:UIControlStateNormal];
        [_torchSwithButton setImage:[[self imageNamed:@"qi_torch_switch_on"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateSelected];
        ...
        _torchSwithButton.imageEdgeInsets = UIEdgeInsetsMake(.0, _torchSwithButton.titleLabel.frame.size.width + 2.5, _torchSwithButton.titleLabel.frame.size.height + 5.0, .0);
